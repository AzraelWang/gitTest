...
@implementation NSData (XZEncrypt)
/**
 *  利用AES加密数据
 *
 *  @param key key
 ...
 *  @return data
 */
- (NSData*)xz_encryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return 解密后数据
 */
- (NSData*)xz_decryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return data
 */
- (NSData*)xz_encryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return 解密后数据
 */
- (NSData*)xz_decryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
